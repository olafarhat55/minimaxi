...
export const mockMachines: Machine[] = [
  ...
  rulCycles: 230,
  ttfHours: 1080,
  explanation: 'No immediate action required. Continue regular monitoring.',
  problemSensor: null,
  currentValue: null,
  normalMin: null,
  normalMax: null,
  ...
  rulCycles: 8,
  ttfHours: 48,
  explanation: 'Schedule preventive maintenance within 48 hours. Check seal integrity.',
  problemSensor: 'temperature',
  currentValue: 85,
  normalMin: 60,
  normalMax: 80,
  modelAccuracy: 0.92,
  ...
  rulCycles: 20,
  ttfHours: 72,
  explanation: 'Immediate maintenance required. High risk of bearing failure.',
  problemSensor: 'vibration',
  currentValue: 1.2,
  normalMin: 0,
  normalMax: 0.5,
  modelAccuracy: 0.93,
  ...
  rulCycles: 45,
  ttfHours: 168,
  explanation: 'Schedule inspection within the next week.',
  problemSensor: 'temperature',
  currentValue: 88,
  normalMin: 60,
  normalMax: 85,
